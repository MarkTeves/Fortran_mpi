...
subroutine interp1D_L(sigma,nx,x,f,xi,outval)
implicit none
...
subroutine interp2D_L(sigma,nx,x,ny,y,f,xi,yi,outval)
implicit none
...
subroutine interp3D_L(sigma,nx,x,ny,y,nz,z,f,xi,yi,zi,outval)
implicit none
...
!--------------------------------------------------------------------------------------------------------------------------------  
subroutine interp4D_L(sigma,nx,x,ny,y,nz,z,nq,q,f,xi,yi,zi,qi,outval)
implicit none
